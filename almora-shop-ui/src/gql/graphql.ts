...
} & { " $fragmentName"?: "ActiveOrderFieldsFragment" };
...
export type ActiveOrderQuery = {
  ...
  activeOrder?:
    | ({ __typename?: "Order" } & {
        " $fragmentRefs"?: {
          ActiveOrderFieldsFragment: ActiveOrderFieldsFragment;
        };
      })
    | null;
};
...
export type SetOrderShippingMethodMutationVariables = Exact<{
  shippingMethodIds: Array<Scalars["ID"]["input"]> | Scalars["ID"]["input"];
}>;
...
export type CollectionsForHomeQueryVariables = Exact<{
  take?: InputMaybe<Scalars["Int"]["input"]>;
}>;

export type CollectionsForHomeQuery = {
  __typename?: "Query";
  collections: {
    __typename?: "CollectionList";
    items: Array<{
...
export const ActiveOrderFieldsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "ActiveOrderFields" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<ActiveOrderFieldsFragment, unknown>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "eligibilityMessage" },
                },
              ],
            },
          },
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "shippingMethodIds" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
>;
export const CollectionsForHomeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CollectionsForHome" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  CollectionsForHomeQuery,
  CollectionsForHomeQueryVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FeaturedProducts" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "take" } },
...
>;
export const CollectionDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "OrdersList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<OrdersListQuery, OrdersListQueryVariables>;
export const OrderDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<OrderDetailQuery, OrderDetailQueryVariables>;
...
>;
export const CustomerAddressesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
